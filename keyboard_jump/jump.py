...
pygame.display.set_caption('Anubhav-Keyboard Typing Game')
background = pygame.image.load('\Real_time_use_app\keyboard_jump\keyback.jpg')
background = pygame.transform.scale(background, (WIDTH, HEIGHT))  #scale image 
font = pygame.font.Font('\Real_time_use_app\keyboard_jump\comic.ttf', 40)
...
def new_word():
    ...
    word_speed += 0.10
    yourword = ''
    words = open("\Real_time_use_app\keyboard_jump\words.txt").read().split(', ')
...
while True:
    ...
    # background = pygame.image.load('\Real_time_use_app\keyboard_jump\teacher-background.jpg')
    # background = pygame.transform.scale(background, (WIDTH, HEIGHT))
    character = pygame.image.load('\Real_time_use_app\keyboard_jump\char.jpg')
    character = pygame.transform.scale(character, (50,50))
    wood = pygame.image.load('\Real_time_use_app\keyboard_jump\wood-.png')
